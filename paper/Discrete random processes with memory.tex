...
\begin{document}
    ...
    For $K=100$, $\alpha=0.1$ {\color{red}and all combinations of input parameters $\tilde{\lambda}$, $p_0$ and $n$}, $92\%$ of all evaluation criteria (for tasks~1--3) were successful and the correct model was found in $85\%$ of cases (task~4).
    ...
    Full results of all evaluation setups{\color{red}, combinations of input parameters $\tilde{\lambda}$, $p_0$ and $n$} as well as several values of parameter $\alpha$ can be found in the GitHub repository (see the last paragraph of the paper).
