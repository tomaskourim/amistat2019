...
The definition of the walk falls into a rather broad class of processes introduced and described in the paper of
Davis and Liu (2016) \cite{davis2012theory}. However, other assumptions, e.g. the condition of contraction, are
not fulfilled by the walk and thus the presented findings cannot be applied.
