...
\hline 
\end{tabular}\foreignlanguage{english}{\caption{\label{tab:Fitting-results}Fitting results. \emph{SP }stands for
...
\tabularnewline
\hline 
\end{tabular}\foreignlanguage{english}{\caption{\label{tab:Fitting-results-Akaike}Finding the optimal model type
