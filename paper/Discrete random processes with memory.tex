...
\begin{document}
    ...
    {\color{red}The experiment consisted of generating $K$ random walks of length $n$, of the same walk type and parameter configuration, and estimating the walk type and parameter values from the generated data.
    ...
    To evaluate the quality of such estimation} the proportion of correctly {\color{red}chosen} model types for the given walk configuration was computed {\color{red}as the proportion of the number of correctly chosen models to the number of analyzed models}.
