...
\begin{document}
    ...
    \end{prop}
    \begin{proof}
    {\color{red}As $EX_{t+1}=E[E(X_{t+1}|X_t)]=E[E(X_{t+1}|P_t)]=E(2P_t -1)$, u}
    ...
    To evaluate the quality of model type estimation {\color{red}(task~4)} the proportion of correctly  {\color{red}chosen} model types for the given walk configuration was computed.
