...
can be defined as
\smallskip\paragraph{\bf Definition 1.}
...
\smallskip\paragraph{\bf Proposition 2.1}
...
\smallskip\paragraph{\bf Corollary 1}
...
\smallskip\paragraph{\bf Definition 2}
\label{succes_rewarded}Let ${\{X_{n}\}}_{n=1}^{\infty}$, $p_{0}$
and $\lambda$ be as in Definition 1. Further
...
are considered to be related to the model from Definition 1. 
...
\smallskip\paragraph{\bf Proposition 3.1}
For all $t\ge 2,$ 
\begin{equation}
...
\end{equation}
From Proposition 3.2 it follows $E(P_{t})=p_{0}$ and
...
and Proposition 3.2 were used. Now for $t=1$ we get
\[
...
\smallskip\paragraph{\bf Corollary 3}
For $t\rightarrow+\infty,$ \textup{
\[
...
\smallskip\paragraph{\bf Definition 3}
\label{2lambdas}Let ${\{X_{n}\}}_{n=1}^{\infty}$ and $p_{0}$ be
as in Definition 1. Further let $\lambda_{0},\,\lambda_{1}\in(0,\,1)$
...
\smallskip\paragraph{\bf Definition 4}
\label{2lambdas-reward}Let ${\{X_{n}\}}_{n=1}^{\infty}$ and $p_{0}$
be as in Definition 1. Further let $\lambda_{0},\,\lambda_{1}\in(0,\,1)$
be constant coefficients and ${\{P_{n}\}}_{n=1}^{\infty}$ be a sequence
of discrete random variables given by
\[
