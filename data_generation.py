...
def generate_random_walk(model_type: str, starting_probability: Decimal, c_lambdas: List[float], walk_steps: int) -> \
        CompleteWalk:
...
def generate_random_walks(model_type: str, starting_probability: Decimal, c_lambdas: List[float], walk_steps: int,
...
def save_walks(walks: List[CompleteWalk], model_type: str, starting_probability: float, c_lambdas: List[float],
